<?php 
  ...
  if(isset($_POST['submit'])){
  	...
  	$query1 = mysql_query("select * from email where roll='$roll'");
      ...
      $query = mysql_query("update `email` set `key`='$keys' where `roll`='$roll';");
  		//$query = mysql_query("update email set key='$keys' where roll='".$roll."'");
//  		$query = mysql_query("update email set key=RAND() where email='$email'");
  		if($query){
			//Send mail....
...
<html lang="en">
  <head>
    ...
    <title>No Dues Management Portal</title>
  ...
  <body>
    ...
    <div align="center">
      <h2>Welcome to No Dues Management Portal!</h2>
    </div>
    <br/><br/><br/><br/>
    <div align="center">
