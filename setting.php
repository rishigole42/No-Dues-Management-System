	...
	if(isset($_POST['password'])){
		...
		if(strcmp($_SESSION['password'],$pass)==0){
			if(strcmp($pass1, $pass2)==0){
				...
				$query = mysql_query("update student set password='$pass1' where roll='".$_SESSION['roll']."'");
				if($query){
...
<html lang="en">
  ...
  <body style="background-color:;">
	  ...
	  <div class="container">
	  	<h3 class="navbar-text"><a href="student-profile-accounts.php"><span class="glyphicon glyphicon-home" title="Home" aria-hidden="true"></span></a></h3>
